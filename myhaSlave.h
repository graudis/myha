...
public:
	...
	static CCenterAccept& getCenterAccept() { return __center_accept; }
	static CMonitor& getMonitor() { return __monitor; }
...
private:
	...
	static CCenterAccept __center_accept;
	static CMonitor __monitor;
